...
class ContentLoadingProgressBar : ProgressBar {
    ...
    var onViewDisplayEvent: OnActionNotify? = null
    var onViewHideEvent: OnActionNotify? = null
    ...
    override fun onVisibilityChanged(changedView: View?, visibility: Int) {
        ...
        if (changedView === this) {
            if (visibility == View.VISIBLE) {
                EventFireUtil.fireEvent(onViewDisplayEvent)
            } else {
                EventFireUtil.fireEvent(onViewHideEvent)
            }
        }
    }
}